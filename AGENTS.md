...
- `docs/progress.md`：项目管理员本地开发流水；
- `docs/update.md`：阶段总结；仅在明确提出整合时再更新。
...
- `docs/database/merchant-module.md`：成员 2 商家入驻、店铺、资质与账号开通数据库设计（V8）。
- `docs/database/V9-system-smtp-and-admin-user.md`：系统 SMTP 运行时配置与手动建号权限（V9）。
...
5. 修改`docs/progress.md`。不要在日常开发中改 `docs/update.md`，除非被明确要求做整合总结。
